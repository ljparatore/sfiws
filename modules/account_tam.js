...
let auth = require("./slack-salesforce-auth"),
    force = require("./force"),
    TAM_TOKEN = process.env.SLACK_TAM_TOKEN;

exports.execute = (req, res) => {

    if (req.body.token != SLACK_TAM_TOKEN) {
    ...
    let slackUserId = req.body.user_id,
        ...
        q = "SELECT Id, Name, CHT_Account_TAM__c FROM Account WHERE Name LIKE '%" + req.body.text + "%' LIMIT 5";
